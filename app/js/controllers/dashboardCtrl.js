ChatApp.controller('dashboardCtrl', ['$scope', '$rootScope', '$http', '$state', '$sessionStorage', '$stateParams', 'CONFIG', function ($scope, $rootScope, $http, $state, $sessionStorage, $stateParams, CONFIG) {
